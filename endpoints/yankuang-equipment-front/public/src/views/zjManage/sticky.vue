<template>
  <div class="app-container" >
    <div class="filter-container" >
      ...
      <el-select class="filter-item" placeholder="所属公司" style="width: 135px;" v-model="listQuery.comp">
        <el-option v-for="item in orgList" :key="item.value" :label="item.label" :value="item.value"></el-option>
      </el-select>
      <el-select class="filter-item" placeholder="大类" style="width: 135px;" v-model="listQuery.sbtypeOne" v-on:change="getEqMiddleTypeList($event)">
        <el-option v-for="item in sbtypeOneList" :key="item.code" :label="item.name" :value="item.code"></el-option>
      </el-select>
      <el-select class="filter-item" placeholder="中类" style="width: 135px;" v-model="listQuery.sbtypeTwo" v-on:change="getEqSmallTypeList($event)">
        <el-option v-for="item in sbtypeTwoList" :key="item.code" :label="item.name" :value="item.code"></el-option>
      </el-select>
      <el-select class="filter-item" placeholder="小类" style="width: 135px;" v-model="listQuery.sbtypeThree" v-on:change="getSbtypeOneNameList($event)">
        <el-option v-for="item in sbtypeThreeList" :key="item.code" :label="item.name" :value="item.code"></el-option>
      </el-select>
      <el-select class="filter-item" placeholder="规格型号" style="width: 135px;" v-model="listQuery.sbmodelCode">
        <el-option v-for="item in sbtypeOneNameList" :key="item.code" :label="item.name" :value="item.code"></el-option>
      </el-select>
      <el-select class="filter-item" placeholder="是否租赁" style="width: 135px;" v-model="listQuery.isLease">
        <el-option v-for="item in isLeaseList" :key="item.value" :label="item.label" :value="item.value"></el-option>
      </el-select>
    </div>
    <div style='padding-bottom:50px;'>
      <div style="float:left;">
          <el-button class="filter-item" style="margin-left: 8px;" type="primary" icon="el-icon-search" size='small' v-waves @click="search">搜索</el-button>
          <el-button class="filter-item" style="margin-left: 8px;" icon="el-icon-refresh" size='small' v-waves @click="reset">重置</el-button>
      </div>
      <div style="float:right;">
        <el-button class="filter-item" style="margin-left: 10px;" type="primary" size='small' v-waves icon="el-icon-circle-plus-outline" @click="handleCreate">添加</el-button>
        <el-button class="filter-item" style="margin-left: 10px;" type="primary" size='small' v-waves icon="el-icon-edit" @click="edit()">编辑</el-button>
        <el-button class="filter-item" style="margin-left: 10px;" type="danger" size='small' v-waves icon="el-icon-delete" @click.prevent="delData()">删除</el-button>
      </div>
    </div>
    ...
    <el-table :key='tableKey' :data="tableData3" stripe border fit highlight-current-row v-loading="listLoading" :height="tableHeight" style="width: 100%;" @selection-change='selectRow' ref="moviesTable">
      ...
      <el-table-column width="130px" align="center" :label="'规格型号'">
        <template slot-scope="scope">
      ...
      <el-table-column width="250px" align="center" :label="$t('仓库')">
        <template slot-scope="scope">
          <span>{{scope.row.ware}}</span>
        </template>
      </el-table-column>
      <el-table-column width="110px" align="center" :label="$t('单价')">
        <template slot-scope="scope">
          <span>{{scope.row.dayLeaseFee}}</span>
        </template>
      </el-table-column>
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item :label="'大类:'" required prop="sbtypeOne">
              <el-select v-model="temp.sbtypeOne" placeholder="请选择" v-on:change="getEqMiddleTypeList($event)">
                <el-option
          ...
          <el-col :span="8">
            <el-form-item :label="'中类:'" required prop="sbtypeTwo">
                <el-select v-model="temp.sbtypeTwo" placeholder="请选择" v-on:change="getEqSmallTypeList($event)">
                  <el-option
        ...
        <el-row>      
          <el-col :span="8">
            <el-form-item :label="'小类:'" required prop="sbtypeThree">
              <el-select v-model="temp.sbtypeThree" placeholder="请选择" v-on:change="getSbtypeOneNameList($event)">
                <el-option
          ...
          <el-col :span="8">
            <el-form-item :label="'规格型号:'" required prop="sbmodelCode">
              <el-select v-model="temp.sbmodelCode" placeholder="请选择">
                <el-option
          ...
          <el-col :span="8">
            <el-form-item :label="'设备识别码:'" :disable='disable' required prop='code'>
              <el-input v-model="temp.code" :maxlength="50"></el-input>
            </el-form-item>
          </el-col>
        </el-row>  
        <el-row>  
          <el-col :span="8">
            <el-form-item :label="'所属公司:'" style="width:100%;" prop='comp'>
              <el-select v-model="temp.comp" placeholder="请选择">
                <el-option
          ...
          <el-col :span="8">
            <el-form-item :label="'是否全新:'" required prop='isNew'>
              <el-select v-model="temp.isNew" placeholder="请选择">
                <el-option
          ...
          <el-col :span="8">
            <el-form-item :label="'功能位置:'" prop="positionCode">
              <el-select v-model="temp.positionCode" placeholder="请选择">
                <el-option
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item :label="'状态编码:'" prop="stateCode">
              <el-select v-model="temp.stateCode" placeholder="请选择">
                <el-option
        ...
        <el-row>
          <el-col :span="8">  
            <el-form-item :label="'是否租赁:'" required prop='isLease'>
                <el-select v-model="temp.isLease" placeholder="请选择">
                  <el-option
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item required :label="'仓库:'" prop='ware'>
              <el-select v-model="temp.ware" placeholder="请选择">
                <el-option
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item :label="'购置价值:'" required prop='buyPrice'>
              <el-input-number v-model="temp.buyPrice" controls-position="right" :min="1" :max="99999"></el-input-number>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item :label="'单价:'" prop="dayLeaseFee">
              <el-input-number v-model="temp.dayLeaseFee" controls-position="right" :min="1" :max="99999"></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="8">
...
import { require_post, require_get, require_put, require_delete } from '@/assets/pubJS'
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        name: [{ required: true, message: '请输入规格型号名称' }],
        ...
        code: [{ msg: '请选择设备识别码', validator: validateRquNumEn }],
      ...
      if (_this.selectlistRow) {
        if (_this.selectlistRow.length !== 0 && _this.selectlistRow.length === 1) {
          _this.$confirm('确认要删除么?', '提示', {
            ...
            require_delete('/v1/sbequipmentt/delete/' + _this.selectlistRow[0].id, {
              token: token,
              authorityCode: 1
            }, { }, function(res) {
              _this.$notify({
