  ...
  <div class="app-container" style="width:100%">
    <div class="filter-container" style="width:100%">
      <div style="float:right;">
        <el-button class="filter-item" size="small" style="margin-left: 10px;" type="primary" icon="el-icon-circle-plus-outline" @click="handleCreate('1')">添加同级</el-button>
        <el-button class="filter-item" size="small" style="margin-left: 10px;" type="primary" icon="el-icon-circle-plus-outline" @click="handleCreate('2')">添加子级</el-button>
        <el-button class="filter-item" size="small" style="margin-left: 10px;" type="primary"  icon="el-icon-edit" @click="edit()">编辑</el-button>
        <el-button class="filter-item" size="small" style="margin-left: 10px;" type="danger" icon="el-icon-delete" @click="delData()">删除</el-button>
      </div>
    </div>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="'编码'" required prop="code">
              <el-input v-model="temp.code" style="width:250px" :maxlength="maxLength" :minlength="minLength"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="'参数类型'" prop="mainParaType">
              <el-select class="filter-item" v-model="temp.mainParaType" style="width:250px">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="'参数类型'" prop="defPara1Type">
              <el-select class="filter-item" v-model="temp.defPara1Type" style="width:250px">
                <el-option v-for="item in paramsTypeList" :key="item.value" :label="item.label" :value="item.value"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="'参数类型'" prop="defPara2Type">
              <el-select class="filter-item" v-model="temp.defPara2Type" style="width:250px">
                <el-option v-for="item in paramsTypeList" :key="item.value" :label="item.label" :value="item.value"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="'参数类型'" prop="defPara3Type">
              <el-select class="filter-item" v-model="temp.defPara3Type" style="width:250px">
                <el-option v-for="item in paramsTypeList" :key="item.value" :label="item.label" :value="item.value"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="'参数类型'" prop="defPara4Type">
              <el-select class="filter-item" v-model="temp.defPara4Type" style="width:250px">
                <el-option v-for="item in paramsTypeList" :key="item.value" :label="item.label" :value="item.value"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="'参数类型'" prop="defPara5Type">
              <el-select class="filter-item" v-model="temp.defPara5Type" style="width:250px">
                <el-option v-for="item in paramsTypeList" :key="item.value" :label="item.label" :value="item.value"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="'参数类型'" prop="defPara6Type">
              <el-select class="filter-item" v-model="temp.defPara6Type" style="width:250px">
                <el-option v-for="item in paramsTypeList" :key="item.value" :label="item.label" :value="item.value"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="'参数类型'" prop="defPara7Type">
              <el-select class="filter-item" v-model="temp.defPara7Type" style="width:250px">
                <el-option v-for="item in paramsTypeList" :key="item.value" :label="item.label" :value="item.value"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="'参数类型'" prop="defPara8Type">
              <el-select class="filter-item" v-model="temp.defPara8Type" style="width:250px">
                <el-option v-for="item in paramsTypeList" :key="item.value" :label="item.label" :value="item.value"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
...
<script>
import Vue from 'vue'
import { require_get, require_put, require_post, require_delete } from '@/assets/pubJS'
...
export default {
  ...
  data() {
    ...
    const validateCode = (rule, value, callback) => { // 编码验证
      ...
      } else if (!this.isSame && value.length !== level * 4) {
        callback(new Error(`请输入${level * 4}位数字编码`))
      } else {
        callback()
      }
    }
  ...
  methods: {
    ...
    getSpTypeInfo(id) { // 获取设备类型详细显示在弹框中
      ...
      require_get('/v1/sbtypeinfo/find/' + id, {
        ...
        _this.temp.code = result.typeCode
