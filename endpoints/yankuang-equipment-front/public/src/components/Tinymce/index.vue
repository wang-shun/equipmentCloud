<template>
  <div class="app-container">
    ...
    <el-table :key='tableKey' :data="specificationModelTable" v-loading="listLoading" border fit highlight-current-row
      style="width: 100%;" @selection-change='selectRow' ref="moviesTable" height="705px">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="800px">
      <el-form :rules="rules" status-icon ref="dataForm" :model="temp" label-position="right" label-width="120px" :disabled="setDisabled">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="功能位置名称" required prop="name">
              <el-input class="filter-item" v-model="temp.name" style="width:250px" :maxlength="30"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <!-- <el-form-item :label="'备注'" prop="remark">
          <el-input type="textarea" v-model="temp.remark" style="width: 98.5%;"></el-input>
        </el-form-item> -->
      </el-form>
